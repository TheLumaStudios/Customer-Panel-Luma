        ...
        <div className="container px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
          <div className="inline-block mb-4">
            <span className="bg-blue-600 text-white text-sm font-semibold px-4 py-2 rounded-full">
              KAMPANYA: Yıllık alımda 10 ay öde, 2 ay ücretsiz kullan
            </span>
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            VDS Sunucu
            <br />
            <span className="text-primary">Sanal Dedicated Sunucu</span>
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Dedicated kaynaklarla güçlendirilmiş sanal sunucularımız, işletmenize
            maksimum performans ve güvenilirlik sunar.
          </p>
        </div>
      </section>
