  ...
  return (
    <div className="min-h-screen bg-[#050505]">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-[#00f2ff]/5 rounded-full blur-[128px]" />
        ...
        <div className="relative container px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 backdrop-blur-sm mb-6">
            <Server className="h-4 w-4 text-[#00f2ff]" />
            <span className="text-sm text-white/70">Fiziksel Sunucu Kiralama</span>
          </div>
      ...
      <section className="py-16">
        <div className="container px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-white/50">Kurumsal ihtiyaçlarınız için en uygun paketi seçin</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {packages.map((pkg, index) => {
              ...
              return (
                <div
                  key={pkg.id}
                  className={`p-8 relative overflow-hidden rounded-2xl bg-white/[0.04] border ${pkg.is_featured ? 'border-[#00f2ff]/50 shadow-xl ring-2 ring-[#00f2ff]/10' : 'border-white/[0.08] hover:border-white/[0.15] transition-colors'}`}
                >
                  {pkg.is_featured && (
                    <div className="absolute top-0 right-0">
                      <div className="bg-[#00f2ff] text-black text-xs font-semibold px-4 py-1 rounded-bl-lg">
                        En Popüler
                      </div>
                    </div>
                  )}
                  ...
                  <div className="mb-6">
                    <div className="inline-flex items-center gap-2 bg-white/[0.04] border border-white/[0.08] rounded-lg px-4 py-2 mb-4">
                  ...
                  <div className="mb-6">
                    ...
                    <div>
                      <span className="text-4xl font-bold text-[#00f2ff]">
                        {formatPrice(pkg.price_monthly)}₺
                      </span>
                      <span className="text-white/50">/ay {!pkg.tax_included && '+KDV'}</span>
                    </div>
                    {pkg.price_annual && (
                  ...
                  {/* Specs */}
                  <div className="space-y-3 mb-6 border-t border-white/[0.08] pt-4">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium text-white">
                        ...
                        {maxRamFeature && <span className="text-xs text-white/30 ml-1">({maxRamFeature})</span>}
                      </span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-white/50 flex items-center gap-1.5">
                    ...
                    {pkg.bandwidth && (
                      <div className="flex justify-between text-sm">
                        <span className="text-white/50">Trafik</span>
                    ...
                    <ul className="space-y-2 mb-8">
                      {features.map((feature, i) => (
                        <li key={i} className="flex items-center gap-2">
                          <Check className="h-4 w-4 text-[#00f2ff] flex-shrink-0" />
                  ...
                  <Button
                    asChild
                    className={`w-full ${pkg.is_featured ? 'bg-[#00f2ff] text-black hover:bg-[#00f2ff]/90' : ''}`}
