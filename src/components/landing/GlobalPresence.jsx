    ...
    <section className="py-24 bg-[#0a0a0a]">
      <div className="container px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-12">
          ...
          <Button variant="outline" className="border-white/[0.10] text-white/70 hover:border-[#00f2ff]/30">View All Locations</Button>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {offices.map((office, index) => (
            <div
              key={index}
              className="bg-[#0a0a0a] border border-white/[0.08] rounded-2xl overflow-hidden hover:border-[#00f2ff]/30 hover:shadow-lg transition-all group"
            >
              {/* Image */}
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-white/50 mb-4">{office.country}</p>

                <div className="space-y-3">
                  <div className="flex items-start gap-2 text-sm">
                    <MapPin className="h-4 w-4 text-[#00f2ff] mt-0.5 flex-shrink-0" />
                    <span className="text-white/50">{office.address}</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <Phone className="h-4 w-4 text-[#00f2ff] flex-shrink-0" />
                    <a
